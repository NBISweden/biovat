...
- [ ] Add new or updated parameters to `nextflow.config` with a [default value](#default-parameter-values). Consider to prefix parameters with the tool name if they are tool-specific and exposed to the user.
